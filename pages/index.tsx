...
export default function Home() {
  ...
  const [structuredErrors, setStructuredErrors] = useState<any[]>([]);
    ...
    <>
      ...
      <main className="main">
        ...
        <ValidatorPanel
          ...
          errors={errors}
          setErrors={setErrors}
          setStructuredErrors={setStructuredErrors}
          highlightedRow={highlightedRow}
            ...
            <>
              ...
              <div className="section animate-fade-in">
                <AIRecommendations
                  ...
                  onAddRule={(rule) => {
                    // Add rule to the rules array with proper configuration
                    console.log('Adding AI rule:', rule);
                    setRules(prev => {
                      const newRule = {
                        ...
                        config: {
                          type: 'ai-recommended',
                          description: rule,
                          reasoning: 'Generated by AI analysis of data patterns',
                          category: 'load-limit',
                          parameters: {
                            entity: 'workers',
                            condition: 'group-based',
                            limit: 'dynamic'
                          }
                        }
                      };
                    ...
                    alert(`✅ Rule added successfully!\n\nRule: ${rule}\n\nYou can now export this rule with your configuration.`);
                  }}
                />
              </div>
